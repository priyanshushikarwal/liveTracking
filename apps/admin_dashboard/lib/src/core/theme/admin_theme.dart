...
class AdminTheme {
  ...
  static ThemeData get darkTheme {
    ...
    return ThemeData(
      ...
      dataTableTheme: const DataTableThemeData(
        headingRowColor: WidgetStatePropertyAll(canvasNightSoft),
        dividerThickness: 1,
        decoration: BoxDecoration(
          border: Border.fromBorderSide(BorderSide(color: hairlineOnDark)),
        ),
      ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: _border(color: onPrimary),
      ...
      navigationRailTheme: NavigationRailThemeData(
        ...
        selectedIconTheme: const IconThemeData(color: onPrimary),
        unselectedIconTheme: const IconThemeData(color: onPrimaryMute),
        selectedLabelTextStyle: _microText(onPrimary),
        unselectedLabelTextStyle: _microText(onPrimaryMute),
      ),
  ...
  static ThemeData get lightTheme {
    return darkTheme.copyWith(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: _border(color: hairlineOnLight),
        enabledBorder: _border(color: hairlineOnLight),
        focusedBorder: _border(color: ink),
        errorBorder: _border(color: error),
        focusedErrorBorder: _border(color: error),
      ...
      navigationRailTheme: NavigationRailThemeData(
        ...
        unselectedIconTheme: const IconThemeData(color: inkMute),
        selectedLabelTextStyle: _microText(ink),
        unselectedLabelTextStyle: _microText(inkMute),
      ),
      popupMenuTheme: PopupMenuThemeData(
        color: canvasLight,
        surfaceTintColor: Colors.transparent,
  ...
  static TextTheme _textTheme(Brightness brightness) {
    ...
    final headlineColor = isDark ? onPrimary : ink;
    ...
    return GoogleFonts.robotoCondensedTextTheme().copyWith(
      ...
      labelMedium: _microText(headlineColor),
  ...
  static OutlineInputBorder _border({Color color = hairlineOnDark}) {
